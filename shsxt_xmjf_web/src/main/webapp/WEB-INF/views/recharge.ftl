...
<#include "include/user_siderbar.ftl">
    <div class="content fr">
        <div class="recharge-title">
            ...
            <div class="recharge-title-right">
                <div class="record-but">
                    <a href="${ctx}/account/rechargeList">
                        <button class="but">
                            充值记录
                        </button>
                    </a>
        ...
        <form id="fm" method="post" action="${ctx}/account/doRecharge" >
            ...
            <div class="recharge-bankCard">
                ...
                <div class="third-pay">
                    ...
                    <div class="verification-img">
                        <img src="${ctx}/image" id="validImg" style="cursor:pointer;"/>
                    </div>
                </div>
                <div class="third-pay">
                    <div class="third-pay-title">
                    ...
                    <input type="password" name="busiPwd" class="recharge-input" id="password"
                           style="margin-top: 18px;margin-left: 10px;float: left"/>
                </div>
                <div class="third-pay">
