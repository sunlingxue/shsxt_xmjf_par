    ...
    <div class="login-content-center">
        ...
        <div class="forget-content">
            ...
            <div class="login_input_code">
                ...
                <div class="phoneNum"><input type="text"  id="_ocx_password" style="ime-mode:disabled" tabindex="2" class="ocx_style"></div>
                <div class="phoneNum-text">确认交易密码:</div>
                <div class="phoneNum"><input type="text"  id="_ocx_password1" style="ime-mode:disabled" tabindex="2" class="ocx_style"></div>
